...
static void add_record()
{
    ...
    FILE *h_two_ptr = fopen("this_cloudcustomer_data.csv", "a+");
    if (!h_two_ptr)
    {
        perror("Error opening file");
        return;
